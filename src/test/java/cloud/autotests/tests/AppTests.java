...
public class AppTests extends TestBase {
    ...
    @DisplayName("https://opensource.dropbox.com/")
    void generatedTest() {
        step("Отекрыть https://opensource.dropbox.com/", () -> {
            // todo
        });
    }
    ...
    void titleTest() {
        step("Open url 'https://opensource.dropbox.com/'", () ->
            open("https://opensource.dropbox.com/"));

        step("Page title should have text 'Dropbox Open Source'", () -> {
            String expectedTitle = "Dropbox Open Source";
